...
from app.api.routes.user.model import UserBase  # noqa: F401 — register model metadata
from app.api.routes.family.model import Family  # noqa: F401 — register model metadata
